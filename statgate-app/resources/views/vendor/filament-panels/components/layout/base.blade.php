...
>
    ...
    >
        ...
        <footer class="bg-[#151a14] border-t border-white/5 py-12 px-4">
            <!-- Tutaj treść Twojej stopki -->
            <div class="max-w-7xl mx-auto text-[#556b50] text-sm text-center">
                <p>&copy; {{ date('Y') }} StatGate, all rights reserved.</p>
            </div>
        </footer>
    </body>
</html>
